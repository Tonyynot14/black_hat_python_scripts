...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="BHP Net Tool", formatter_class=argparse.RawDescriptionHelpFormatter, epilog='''Example:
    ...
    parser.add_argument('-t','--target',default="127.0.0.1",help='specific IP')
